...
public class CheckIfKthBitIsSetOrUnset {
  public static void main(String[] args) {
    System.out.println("First set-bit position for number: 18 is -> " + checkIfKthSetOrUnset(18));
    System.out.println("First set-bit position for number: 5 is -> " + checkIfKthSetOrUnset(5));
    System.out.println("First set-bit position for number: 32 is -> " + checkIfKthSetOrUnset(32));
